  ...
  async findOne(id: number): Promise<Job> {
    const job = await this.jobRepository.findOne({
      ...
      relations: [
        ...
        'applications.journalist.skills',
        'applications.journalist.skills.skill',
        'applications.journalist.mediaWorkTypes',
        'applications.journalist.mediaWorkTypes.mediaWorkType',
        'applications.journalist.languages',
        'applications.journalist.languages.language',
        'jobRequiredSkills',
