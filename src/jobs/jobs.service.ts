  ...
  async findOne(id: number): Promise<Job> {
    const job = await this.jobRepository.findOne({
      ...
      relations: [
        ...
        'applications.journalist.user.country',
        'applications.journalist.journalistSkills',
        'applications.journalist.journalistSkills.skill',
        'applications.journalist.journalistMediaWorkTypes',
        'applications.journalist.journalistMediaWorkTypes.mediaWorkType',
        'applications.journalist.journalistLanguages',
        'applications.journalist.journalistLanguages.language',
        'jobRequiredSkills',
