-- Additional dummy data script for existing database
...
(5, 0, NULL, 0, NULL, 0, 'Digital media expert with strong background in social media management, content creation, and digital marketing strategies for media organizations.', 4.5, 22, 65, 1, 55.00, 440.00, 3500.00, NOW(), NOW(), 9, 1, 5, NOW(), 'Strong digital media skills', 'mid_level', '{"linkedin": "emily-davis-media", "youtube": "EmilyDavisMedia"}', '{"portfolio": "https://emilydavis.media/portfolio", "case_studies": "https://emilydavis.media/cases"}', '["Digital Marketing Certificate", "Social Media Management"]', '{"clients": ["Major News Networks", "Media Companies"]}'),
